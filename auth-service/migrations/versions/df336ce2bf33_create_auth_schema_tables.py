...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_auth_roles_name"), "roles", ["name"], unique=True, schema="auth"
    )
    op.create_table(
        "users",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["permission_id"], ["auth.permissions.id"], ondelete="CASCADE"
        ),
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_auth_permissions_name"), table_name="permissions", schema="auth"
    )
